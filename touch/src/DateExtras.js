  ...
  Ext.DateExtras = {
    ...
    clearTime: function (date, clone) {
      ...
      if (date.getDate() != d) { // account for DST (i.e. day of month changed when setting hour = 0)
        ...
        for (var hr = 1, c = utilDate.add(date, Ext.Date.HOUR, hr); c.getDate() != d; hr++, c =
          utilDate.add(date, Ext.Date.HOUR, hr)) {
          ;
        }
    ...
    add: function (date, interval, value) {
      ...
      switch (interval.toLowerCase()) {
        ...
        case Ext.Date.MONTH:
          ...
          if (day > 28) {
            day =
              Math.min(day, Ext.Date.getLastDateOfMonth(Ext.Date.add(Ext.Date.getFirstDateOfMonth(date), 'mo', value)).getDate());
          }
          d.setDate(day);
